...
* [gcull](https://github.com/krnsk0/gcull) is a small, well-tested CLi application for interactively deleting merged and stale local git branches (Typescript, vitest); on NPM [here](https://www.npmjs.com/package/gcull)
